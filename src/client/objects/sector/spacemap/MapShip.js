...
function MapShip(game, shipSettings, settings) {
...
MapShip.prototype = Object.create(engine.Graphics.prototype);
MapShip.prototype.constructor = MapShip;

MapShip.prototype.update = function(){
...
MapShip.prototype.test = function(){
...
MapShip.prototype._renderWebGL = function(renderer) {
    if(this.needUpdate){
        this.test();
        this.update();
    }
